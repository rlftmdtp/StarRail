package starrail.recommend.controller;
...
import starrail.recommend.service.RecommenderService;
...
public class RecommenderController {
	...
	public void todayTag(HttpServletRequest request, Model model){
		...
		List<HashSearchVO2> tag_list = new ArrayList<HashSearchVO2>();
		...
		try {
			if(((UserVO) session.getAttribute("login")) != null){
				...
				model.addAttribute("tag_list", null);
			}
