...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container" >
        <a class="navbar-brand js-scroll-trigger" href="/starrail/main/main"><h1 style="font-weight: bold;">Hello StarRail</h1></a>
        ...
        <hr>
         ...
         <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Planner</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="/starrail/partner/partner">Partner</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Recommended</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Share</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Postscript</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Expense</a>
            </li>
          </ul>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="/starrail/main/login">&nbsp;Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">My Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">Reservation</a>
            </li>
          </ul>
        </div>
      </div>
